...
$command_kq="iptables -t nat -A user_portal -p tcp -m multiport --dports 80,8080 -j REDIRECT --to-ports 8080".PHP_EOL."iptables -t nat -A user_portal -p tcp --dport 443 -j REDIRECT --to-ports 4433".PHP_EOL."iptables -t nat -A user_portal -j DNAT --to-destination 127.0.0.1";
